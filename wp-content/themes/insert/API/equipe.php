...
function register_equipe_api_route() {
    register_rest_route('api', '/equipe', array(
        'methods'  => 'GET',
        'callback' => 'get_equipe_page_data',
        'permission_callback' => '__return_true',
    ));
}
add_action('rest_api_init', 'register_equipe_api_route');

function get_equipe_page_data($request) {
    $post_id = 200;
