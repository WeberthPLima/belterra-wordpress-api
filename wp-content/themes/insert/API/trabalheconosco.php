...
function register_trabalhe_conosco_api_route() {
    register_rest_route('api', '/trabalhe-conosco', array(
        'methods'  => 'GET',
        'callback' => 'get_trabalhe_conosco_page_data',
        'permission_callback' => '__return_true',
    ));
}
add_action('rest_api_init', 'register_trabalhe_conosco_api_route');

function get_trabalhe_conosco_page_data($request) {
    $post_id = 198;
